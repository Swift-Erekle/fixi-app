...
const CAT_ICONS = { 'ელექტრიკოსი': '⚡', 'სანტექნიკი': '🔧', 'კონდიციონერი': '❄️', 'მხატვარი': '🎨', 'დურგალი': '🪚', 'ინტერნეტი': '🌐', 'სხვა': '🛠️', 'მშენებელი': '🏗️', 'მებაღე': '🌿', 'ტექნიკოსი': '💻', 'სახლი': '🏠', 'ფილების': '🪟', 'შემდუღებელი': '🔩', 'მეკარე': '🔑', 'ავტო': '🚗', 'ძრავის': '🚗', 'მღებავი': '🚗', 'მეთუნუქე': '🚗', 'პლასტმასის': '🚗', 'ელექტრო სისტემის': '🚗', 'ზეთის': '🚗', 'სავალი': '🚗', 'გამონაბოლქვი': '🚗', 'ტრანსმისიის': '🚗' };
